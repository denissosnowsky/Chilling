...
router.post(
  ...
  [
    ...
    check("password", "Введіть будь ласка пароль")
      .trim()
      .isLength({ min: 1 })
      .escape(),
    check("name", "Введіть будь ласка ім'я")
      ...
      .isLength({ min: 1 })
      .escape(),
    check("surname", "Введіть будь ласка прізвище")
      .trim()
      .isLength({ min: 1 })
      .escape(),
    check("city", "Введіть будь ласка місто")
      .trim()
      .isLength({ min: 1 })
      .escape(),
  ],
...
router.post(
  "/login",
  [
    check("email", "Введіть будь ласка коректний e-mail")
      .normalizeEmail()
      .isEmail()
      .escape(),
