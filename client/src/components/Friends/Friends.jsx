...
const Friends = ({isFetching, friends, removeFriendThunk, currentPageUsers, currentPageFriends, totalFriendsCount, pageSizeUsers, pageSizeFriends, changePageFriends, searchedPhrase, changeSearchedPhraseFr, allFriends, isFetchingIsFriend}) => {
    ...
    return(
        <div>
            ...
            {isFetching 
                ...
                :
                friends.map(friend=><Person key={friend.friend_id}
                    user={friend.friend} 
