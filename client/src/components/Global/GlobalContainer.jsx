...
import { changePageUsers, changeSearchedPhrase, getUsersThunk, setPage } from '../../redux/usersReducer';
import { addFriendThunk, removeFriendThunk } from '../../redux/friendsReducer';
import { useEffect} from 'react';
import Global from './Global';


const GlobalContainer = ({getUsersThunk, users, isFetching, addFriendThunk, removeFriendThunk, currentPageUsers, totalUsersCount, pageSizeUsers, changePageUsers, pageSizeFriends, currentPageFriends, searchedPhrase, changeSearchedPhrase, isFetchingIsFriend}) => {
...
export default compose(withRouter, connect(mapStateToProps, {getUsersThunk, addFriendThunk, removeFriendThunk, changePageUsers, changeSearchedPhrase}))(GlobalContainer);
