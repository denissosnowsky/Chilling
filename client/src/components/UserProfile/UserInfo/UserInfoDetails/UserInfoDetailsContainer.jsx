...
import { saveBirth, saveBook, saveCity, saveEducation, savePhone, saveStatus } from '../../../../redux/profileReducer';
...
const UserInfoDetailsContainer = ({city, birth, education, phone, book, status, me, saveStatus, saveCity, saveBirth, saveEducation, savePhone, saveBook, ...props}) => {
...
export default compose(withRouter, connect(null, {saveStatus, saveCity, saveBirth, saveEducation, savePhone, saveBook}))(UserInfoDetailsContainer);