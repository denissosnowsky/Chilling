...
import { addPostThunk, addTempDislike, addTempLike, dislikePostThunk, fetchingLoadBtnPost, getPostsThunk, likePostThunk, removePostThunk } from '../../../redux/postsReducer';
import { connect } from 'react-redux';
import { useEffect, useRef, useState } from 'react';
import UserPosts from './UserPosts';


const UserPostsContainer = ({user, posts, myId, addPostThunk, getPostsThunk, isFetching, removePostThunk, likePostThunk, dislikePostThunk, count, portion, isFetchingPostAdd, isFetchingPostDelete, addTempLike, addTempDislike, fetchingLoadBtnPost, isFetchingLoadBtn}) => {
...
export default connect(mapStateToProps, {addPostThunk, getPostsThunk, removePostThunk, likePostThunk, dislikePostThunk, addTempLike, addTempDislike, fetchingLoadBtnPost})(UserPostsContainer);