...
const LogSignContainer = ({message, isRegistered, isFetching, registerThunk, loginThunk, messageOut}) => {
    ...
    useEffect(()=>{
        (message && setTimeout(()=>{messageOut()}, 3000));
    }, [message]);

    return(
        <LogSign message={message}
...
export default connect(mapStateToProps, {registerThunk, loginThunk, messageOut})(LogSignContainer);
