    ...
    <div className={s.sign__form}>
      ...
      <Formik
        ...
        validationSchema={Yup.object({
          ...
          name: Yup.string().required("Введіть будь ласка Ім'я"),
          surname: Yup.string().required("Введіть будь ласка прізвище"),
          city: Yup.string().required("Введіть будь ласка місто"),
        })}
        onSubmit={(values) => {
          register(values);
        }}
