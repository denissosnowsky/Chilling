            ...
            >
                <Form>
                    ...
                    <TextInput
                        ...
                        errorclass={s.error}
                    />
                    <button className={cs([s.submit], "w-100", "btn", "btn-lg", "btn-danger")} type="submit">Увійти</button>
                    <button type="button" className={cs([s.btn], "btn", "btn-outline-danger")} onClick={()=>toggleLogged(false)}>Зареєструватися</button>
                </Form>
            </Formik>
        </div>
    )
