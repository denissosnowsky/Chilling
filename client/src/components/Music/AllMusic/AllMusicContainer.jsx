...
import { addMusic, getAllMusicThunk, deleteMusic, changeSearchedPhraseMusicAll, fetchingLoadBtnAll, fetchingSearchMusic } from '../../../redux/musicReducer';
import { useEffect, useState } from 'react';
import AllMusic from './AllMusic';

const AllMusicContainer = ({allMusic, isFetchingAll, getAllMusicThunk, addMusic, deleteMusic, searchedPhraseAll, changeSearchedPhraseMusicAll, portion, allCount, isFetchingAddSong, fetchingLoadBtnAll, isFetchingLoadBtnAll, isFetchingSearch, fetchingSearchMusic}) => {
...
export default connect(mapStateToProps, {getAllMusicThunk, addMusic, deleteMusic, changeSearchedPhraseMusicAll, fetchingLoadBtnAll, fetchingSearchMusic})(AllMusicContainer);