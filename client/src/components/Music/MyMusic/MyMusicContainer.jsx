...
import { changeSearchedPhraseMusicMy, deleteMusic, fetchingLoadBtnMy, fetchingSearchMusic, getMyMusicThunk } from '../../../redux/musicReducer';
import MyMusic from './MyMusic';
import { useEffect, useState } from 'react';


const MyMusicContainer = ({isFetchingMy, myMusic, getMyMusicThunk, deleteMusic, searchedPhraseMy, changeSearchedPhraseMusicMy, myMusicCount, portion, myCount, isFetchingAddSong, isFetchingLoadBtnMy, fetchingLoadBtnMy, isFetchingSearch, fetchingSearchMusic}) => {
    ...
    return(
        <MyMusic isFetchingMy={isFetchingMy}
                myMusic={myMusic}
...
export default connect(mapStateToProps, {getMyMusicThunk, deleteMusic, changeSearchedPhraseMusicMy, fetchingLoadBtnMy, fetchingSearchMusic})(MyMusicContainer);
