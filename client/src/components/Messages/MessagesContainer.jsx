...
import { fetchingLoadMenu, getMessagesMenuThunk, getMessagesMenuThunkUpdate } from '../../redux/messageReducer';
import Messages from './Messages';
import { useEffect, useState } from 'react';

const MessagesContainer = ({isFetchingMenu, myId, menuMessage, getMessagesMenuThunk, menuCount, portion, isFetchingLoadMenu, fetchingLoadMenu, getMessagesMenuThunkUpdate}) => {
    ...
    return (
        <Messages isFetchingMenu={isFetchingMenu}
                myId={myId}
...
export default connect(mapStateToProps, {getMessagesMenuThunk, fetchingLoadMenu, getMessagesMenuThunkUpdate})(MessagesContainer);
