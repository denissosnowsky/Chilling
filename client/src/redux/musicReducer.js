...
export const getAllMusicThunk = (searchedPhrase, portion, currentPage, id) => async (dispatch) => {
    const res = await musicAPI.getAllMusic(searchedPhrase, portion, currentPage);
    if(res.resultCode === 0){
...
export const getMyMusicThunk = (searchedPhrase, portion, currentPage, id) => async (dispatch) => {
...
export const addMusic = (id, searchedPhrase, portion, currentPage) => async (dispatch) => {
...
export const deleteMusic = (id, searchedPhrase, portion, currentPage) => async (dispatch) => {
    dispatch(fetchingAddSong(true, id));
