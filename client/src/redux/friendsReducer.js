...
export const getFriendsThunkUpdate =
  (pageNumber, pageSize, searchedPhrase, id) => async (dispatch) => {
    const res = await friendsAPI.getFriends(
      pageNumber,
      pageSize,
      searchedPhrase
...
export const addFriendThunk =
  ...
  async (dispatch) => {
    ...
    if (res.resultCode === 0) {
      ...
      console.log(res);
      dispatch(
        getUsersThunkUpdate(currentPageUsers, pageSizeUsers, searchedPhrase)
      );
      dispatch(
        getFriendsThunkUpdate(
          currentPageFriends,
          pageSizeFriends,
          searchedPhrase,
          id
...
export const removeFriendThunk =
  (
    id,
    currentPageUsers,
    pageSizeUsers,
